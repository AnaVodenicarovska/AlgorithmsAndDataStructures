...
public class DLLDomashni1 {
	public static void DLLKreirajListaNaizmenichno(DLL<Integer> lista1, DLL<Integer> lista2, DLL<Integer> lista3, int N) {
	...
	public static void main(String[] args) throws IOException {
		...
		s = br.readLine();
		int broj2 = Integer.parseInt(s);
		DLLKreirajListaNaizmenichno(lista1, lista2, lista3, broj2);
