...
public class DLLDomashni1ISPIT {
	public static void Funkcija1(DLL<Integer> lista1, DLL<Integer> lista2, DLL<Integer> rezultat, int N) {
	...
	public static void main(String[] args) throws IOException {
		...
		Funkcija1(lista1, lista2, rezultat, n);
