...
public class DLLDomashni2 {
	public static void DLLKreirajListiNaizmenichno(DLL<Integer> lista1, DLL<Integer> lista2, DLL<Integer> lista3, int N) {
		DLLNode<Integer> p=lista1.getLast();
		while(p!=null) {
			for(int i=0;i<N;i++) {
				if(p==null)
					break;
				lista2.insertLast(p.element);
				p=p.pred;
			}
			for(int i=0;i<N;i++) {
				if(p==null)
	...
	public static void main(String[] args) throws IOException {
		...
		DLLKreirajListiNaizmenichno(lista1, lista2, lista3, broj2);
